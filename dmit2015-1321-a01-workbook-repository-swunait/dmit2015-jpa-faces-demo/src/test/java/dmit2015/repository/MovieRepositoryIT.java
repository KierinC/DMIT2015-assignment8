...
import common.listener.ApplicationStartupListener;
...
//                .addAsLibraries(pomFile.resolve("org.hibernate.orm:hibernate-spatial:6.2.6.Final").withTransitivity().asFile())
