...
/**
 * This is the creating view backing bean class for Country
...
public class CountryCreateView {
    ...
    // Define the Region for the Country
    @Getter
    @Setter
    ...
    public String onCreateNew() {
        ...
        try {
            if (_countryRepository.findById(newCountry.getCountryId()).isPresent()) {
                Messages.addGlobalError("Country ID {0} is already in use. Enter another value,", newCountry.getCountryId());
            } else {
