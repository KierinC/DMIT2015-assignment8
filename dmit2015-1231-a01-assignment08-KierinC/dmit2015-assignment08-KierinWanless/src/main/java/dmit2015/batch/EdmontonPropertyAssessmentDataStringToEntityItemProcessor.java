...
@Named
@Dependent
public class EdmontonPropertyAssessmentDataStringToEntityItemProcessor implements ItemProcessor {
     ...
     */
    @Override
    public EdmontonPropertyAssessmentData processItem(Object item) throws Exception {
        // TODO: Write the code to convert the `item` object to an data type required by the ItemWriter
        String line = (String) item;

       return EdmontonPropertyAssessmentData.parseCsv(line).orElseThrow();
    }
