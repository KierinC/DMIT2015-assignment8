...
@Named
@Dependent
public class EdmontonPropertyAssessmentDataEntityToDatabaseItemWriter extends AbstractItemWriter {
    ...
    public void writeItems(List<Object> items) throws Exception {
        for (Object item : items) {
            EdmontonPropertyAssessmentData currentItem = (EdmontonPropertyAssessmentData) item;
